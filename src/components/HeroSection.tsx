...
export const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 pt-28 sm:pt-32 pb-12 overflow-hidden">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-6">
              ...
              <div className="flex items-baseline gap-3">
                <span className="text-xl text-muted-foreground line-through">R$ 150,00</span>
                <span className="text-3xl md:text-4xl font-bold text-accent">R$ 99,99</span>
              </div>
            </div>
