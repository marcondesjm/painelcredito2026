...
const StepCard = ({ 
  ...
  return (
    <div className={`relative bg-card/50 backdrop-blur-sm border border-border/50 rounded-2xl p-6 ${isFirst ? 'border-primary/50' : ''}`}>
      {/* Step number */}
      <span className="text-4xl font-bold text-primary/30 mb-4 block">{number}</span>
