...
export const WhatsAppButton = ({ number, message }: WhatsAppButtonProps) => {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-50 flex items-center gap-2 md:bottom-6 md:right-6 bg-whatsapp rounded-full pl-4 pr-3 py-2.5 shadow-lg hover:scale-105 transition-transform duration-300 hover:shadow-[0_0_20px_hsl(var(--whatsapp)_/_0.5)]"
    >
